...
Matrix4x4 Matrix4x4::MakeAffinMatrix(const Transform& transform) {
	...
	if (transform.isUseOtherRotateMat_) {
		...
		Matrix4x4 result = {
		transform.scale_.x * transform.rotMat_[Transform::All].m[0][0],
		transform.scale_.x * transform.rotMat_[Transform::All].m[0][1],
		transform.scale_.x * transform.rotMat_[Transform::All].m[0][2],
		0,
		transform.scale_.y * transform.rotMat_[Transform::All].m[1][0],
		transform.scale_.y * transform.rotMat_[Transform::All].m[1][1],
		transform.scale_.y * transform.rotMat_[Transform::All].m[1][2],
		0,
		transform.scale_.z * transform.rotMat_[Transform::All].m[2][0],
		transform.scale_.z * transform.rotMat_[Transform::All].m[2][1],
		transform.scale_.z * transform.rotMat_[Transform::All].m[2][2],
		0,
